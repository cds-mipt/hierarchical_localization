...
from .utils.read_write_model import (
        read_cameras_binary, read_cameras_text, read_images_binary, read_images_text, CAMERA_MODEL_NAMES)
...
def create_db_from_model(empty_model, database_path):
    if database_path.exists():
        logging.warning("Database already exists, removing the old one")
...
def import_matches(image_ids, database_path, pairs_path, matches_path,
    ...
    for name0, name1 in tqdm(pairs):
        name0, name1 = name0.rstrip('.png'), name1.rstrip('.png')
